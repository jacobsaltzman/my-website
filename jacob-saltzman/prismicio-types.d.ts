...
type ProjectsDocumentDataSlicesSlice = RichTextSlice;
...
interface ProjectsDocumentData {
  ...
  /**
   * Snippet Image field in *Projects*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: projects.snippet_image
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  snippet_image: prismic.ImageField<never>;
...
interface SettingsDocumentData {
  ...
  /**
   * Fallback OG field in *Settings*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.fallback_og
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  fallback_og: prismic.ImageField<never>;
...
export interface ShowcaseSliceDefaultPrimary {
   ...
   */
  icon: prismic.SelectField<"planet" | "puzzle">;
